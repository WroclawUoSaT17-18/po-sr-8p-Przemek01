...
public class PermissionRequestActivity extends AppCompatActivity {
    ...
    private static String[] PERMISSIONS_ALL = {Manifest.permission.WRITE_EXTERNAL_STORAGE,Manifest.permission.READ_EXTERNAL_STORAGE}; //TODO You can Add multiple permissions here.
